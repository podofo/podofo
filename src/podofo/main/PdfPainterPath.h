...
public:
    /** Append a line segment to the current path
    ...
    void AddLineTo(double x1, double y1, double x2, double y2);
     ...
     */
    void AddCubicBezier(double x1, double y1, double x2, double y2, double x3, double y3);

    void AddCubicBezierTo(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4);
     ...
     */
    void AddCircleTo(double x, double y, double radius);
     ...
     */
    void AddEllipseTo(double x, double y, double width, double height);

    /** Add an arc into the current path to the given coordinates
     *  \param x x coordinate of the ellipse (left coordinate)
     *  \param y y coordinate of the ellipse (top coord
     *	\angle1 in radians
     *	\angle2 in radians
     */
    void AddArcTo(double x, double y, double radius, double angle1, double angle2);
     ...
     */
    void AddRectangleTo(double x, double y, double width, double height,
     ...
     *  \param roundY rounding factor, y direction
     */
    void AddRectangleTo(const PdfRect& rect, double roundX = 0.0, double roundY = 0.0);
...
public:
    PdfDrawMode GetDrawMode() const { return m_DrawMode; }
    void SetDrawMode(PdfDrawMode mode) { m_DrawMode = mode; }
