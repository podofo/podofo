...
#ifndef PODOFO_WRAPPER_PDFERRORH
#define PODOFO_WRAPPER_PDFERRORH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfError.h> when building against a podofo build directory
