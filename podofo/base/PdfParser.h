...
#ifndef PODOFO_WRAPPER_PDFPARSERH
#define PODOFO_WRAPPER_PDFPARSERH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfParser.h> when building against a podofo build directory
