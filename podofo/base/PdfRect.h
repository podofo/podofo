...
#ifndef PODOFO_WRAPPER_PDFRECTH
#define PODOFO_WRAPPER_PDFRECTH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfRect.h> when building against a podofo build directory
