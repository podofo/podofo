...
#ifndef PODOFO_WRAPPER_PDFSTRINGH
#define PODOFO_WRAPPER_PDFSTRINGH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfString.h> when building against a podofo build directory
