...
#ifndef PODOFO_WRAPPER_PDFCOLORH
#define PODOFO_WRAPPER_PDFCOLORH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfColor.h> when building against a podofo build directory
