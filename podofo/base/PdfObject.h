...
#ifndef PODOFO_WRAPPER_PDFOBJECTH
#define PODOFO_WRAPPER_PDFOBJECTH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfObject.h> when building against a podofo build directory
