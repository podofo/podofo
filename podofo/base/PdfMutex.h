...
#ifndef PODOFO_WRAPPER_PDFMUTEXH
#define PODOFO_WRAPPER_PDFMUTEXH
/*
 * This is a simple wrapper include file that lets you include
 * <podofo/base/PdfMutex.h> when building against a podofo build directory
 ...
 */
#include "../../src/base/util/PdfMutex.h"
#endif
