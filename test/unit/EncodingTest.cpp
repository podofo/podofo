...
void EncodingTest::testDifferences()
{
    ...
    PdfName name;
    CPPUNIT_ASSERT_EQUAL( difference.Contains( 0, name ), true );
    CPPUNIT_ASSERT_EQUAL( name, PdfName("A") ); 

    CPPUNIT_ASSERT_EQUAL( difference.Contains( 9, name ), true );
    CPPUNIT_ASSERT_EQUAL( name, PdfName("F") ); 

    CPPUNIT_ASSERT_EQUAL( difference.Contains( 255, name ), true );
    CPPUNIT_ASSERT_EQUAL( name, PdfName("X") ); 

    CPPUNIT_ASSERT_EQUAL( difference.Contains( 100, name ), false );
